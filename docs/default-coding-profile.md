...
The profile constructor accepts an explicit workspace root, operation adapters/capability policy,
and optional replacements/removals/additions. It returns:
...
| `core/tools/grep.ts` | `createGrepTool`, `createGrepToolDefinition`, `grepToolSystemPromptContribution` | `102814acd9b220eb16e87f9f18b4e0957699a5188bd5cff80ac0af0364d7c24` |
...
Every profile fixture uses a temporary fixture workspace created by the controller. No fixture
consults the repository cwd, home directory, environment credentials, `.pi`, sessions, or a live
provider.
