...
1. Add a provider-free JSON fixture under `crates/pi-agent-core/fixtures/declarative/`.
2. Add its canonical result under `crates/pi-agent-core/fixtures/expected/`.
3. Run `crates/pi-agent-core/fixtures/run.sh`.
...
`crates/pi-agent-core/profile/`. Rust tests validate that capture and the concrete explicit
