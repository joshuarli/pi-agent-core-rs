...
use pi_agent_core::state::{AgentMessage, AgentPhase, ModelDescriptor, SerializedJson, ToolCallId};
...
impl HookSet for FixtureHooks {
    ...
    fn prepare_next_turn(
        &self,
        mut context: ContextEnvelope,
    ) -> Result<AgentLoopTurnUpdate, pi_agent_core::error::HookError> {
...
struct FixtureTool {
    name: String,
    description: String,
    execution_mode: pi_agent_core::tool::ToolExecutionMode,
    schema: JsonValue,
...
impl AgentTool for FixtureTool {
    ...
    fn execution_mode(&self) -> pi_agent_core::tool::ToolExecutionMode {
        self.execution_mode
    }
