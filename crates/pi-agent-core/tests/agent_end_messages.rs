...
use pi_agent_core::state::{AssistantToolCall, Message, SerializedJson, StopReason, ToolCallId};
...
fn agent_end_messages(agent_run: &pi_agent_core::RunHandle) -> Vec<Message> {
    agent_run
        .events()
        .into_iter()
