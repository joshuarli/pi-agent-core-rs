...
use pi_agent_core::default_tools::{
...
use pi_agent_core::tool::{AgentTool, ToolCall, ToolContext, ToolUpdateSink};
use pi_agent_core::DefaultCodingTools;
use std::fs;
...
fn execute(
    ...
    name: &str,
    arguments: &str,
) -> Result<pi_agent_core::tool::ToolResult, ToolError> {
...
impl CodingOperations for FailingOperations {
    ...
    ) -> OperationFuture<'a, Vec<pi_agent_core::default_tools::GrepMatch>> {
        self.fail()
    }
    ...
    fn execute_command<'a>(
        ...
        _environment: &'a pi_agent_core::default_tools::CommandEnvironment,
